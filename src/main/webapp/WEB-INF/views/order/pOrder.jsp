							...
							<div id="collapse2" class="panel-collapse collapse  in" role="tabpanel">
								<div class="panel-body">
									<table class="ordertable">
										...
										<tr>
											<td colspan="4">
												<select name="ORDER_MEMO" id="ORDER_MEMO">
										...
										<tr>
											<td colspan="4">
												<textarea id="selboxDirect" name="selboxDirect" fw-filter="" fw-label="배송 메세지" fw-msg="" maxlength="255" cols="70"></textarea>
											</td>
										</tr>
									</table>
								</div>
...
$(".submitbtn").on("click", function() {
	...
	$(".ordergoods").each(function(index, element) {
		// 반복여부 체크
		alert(arrIndex); 
