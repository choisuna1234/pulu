		...
		<div style="text-align: center;">
			...
			<main>
				<div style="line-height:200%;">
					...
					<br> ① 회원은 “푸르뎁”에 언제든지 탈퇴를 요청할 수 있으며 “푸르뎁”은 즉시 회원탈퇴를 처리합니다.<br />
					② 회원이 다음 각 호의 사유에 해당하는 경우, “푸르뎁”은 회원자격을 제한 및 정지시킬 수 있습니다.<br /> 1.
					가입 신청 시에 허위 내용을 등록한 경우<br /> 2. “푸르뎁”을 이용하여 구입한 재화 등의 대금, 기타
					“푸르뎁”이용에 관련하여 회원이 부담하는 채무를 기일에 지급하지 않는 경우<br /> 3. 다른 사람의 “푸르뎁”
					이용을 방해하거나 그 정보를 도용하는 등 전자상거래 질서를 위협하는 경우<br /> 4. “푸르뎁”을 이용하여 법령
					또는 이 약관이 금지하거나 공서양속에 반하는 행위를 하는 경우<br /> ③ “푸르뎁”이 회원 자격을 제한?정지 시킨
					후, 동일한 행위가 2회 이상 반복되거나 30일 이내에 그 사유가 시정되지 아니하는 경우 “푸르뎁”은 회원자격을 상실시킬
					수 있습니다.<br /> ④ “푸르뎁”이 회원자격을 상실시키는 경우에는 회원등록을 말소합니다. 이 경우 회원에게 이를
					통지하고, 회원등록 말소 전에 최소한 30일 이상의 기간을 정하여 소명할 기회를 부여합니다.


					<h4>${loginName} 회원님 회원탈퇴를 진행하시려면 비밀번호를 입력하고 확인 버튼을 눌러주세요.</h4>
					<h5>회원 ID = ${loginId}</h5>
				</div>
				...
				<form class="needs-validation" method="post" id="frm" name="frm"
					...
					<div style="text-align: center;" id="join_button">
						<input type="submit" name="submit" class="insert_bt" value="탈퇴하기">
						<input type="button" onclick="location.href='myPage.pulu'"
							class="insert_bt" value="마이페이지">
					</div>
				</form>
			</main>
		</div>
