	...
	<div class="container">
		<div class="sub_content">
					...
					<div class="detailInfoArea">
						<div class="InfoArea">
							...
							<div class="InfoBody">
								...
								<form id="detailForm">
									<input type="hidden" id="goodsNum" name="GOODS_NUM" value="${map.GOODS_NUM }">
			...
			<div class="detailConTentContainer">
                ...
                <div id="reviewList"><jsp:include page="comment/reviewList.jsp"></jsp:include></div>
						</table>
					</div>
				</div>
				<div class="detailContent3">
					<div class="detailTopMenu">
						<ul>
							...
							<li title="상품리뷰 이동"  >
								<a href="#here2">
									<p>구매후기<span style="display: inline-block;" class="xans-element- xans-product xans-product-action">(후기개수)</span></p>
								</a>
							</li>
							<li title="상품문의 이동" id="selected"  >
								<a href="#none" name="here3">
									<p>상품문의 <span style="display: inline-block;" class="xans-element- xans-product xans-product-action ">(문의개수)</span></p>
								</a>
							</li>
							<li title="배송안내 이동">
								<a href="#here4">
				...
				<div class="detailContent4">
					<div class="detailTopMenu">
						<ul>
							...
							<li title="배송안내 이동" id="selected">
								<a href="#none" name="here4">
									<p>이용안내</p>
								</a>
							</li>
						</ul>
					...
					<div class="Detail_cont">
						<table class="dummy" align="center" width="1000" height="800" border=1 border-color=>
						
							<tr><td>상품결제정보<br>
결제 전에 꼭 확인해주세요.<br>
주문하신 분과 받으실 분의 성함과 연락처, 주소를 확인해주세요. 제품의 안전한 배송을 위한 필수 정보입니다.<br>
<br>
...
주문취소<br>
<br>
주문 취소는 배송일(수령일 기준) 2일 전까지 고객센터 또는 1:1 문의 게시판으로 취소 요청이 가능합니다. <br>
<br>
판다의 샐러드는 주문이 확인 된 이후 수량에 맞춰 생산하기 때문에 생산이 된 이후에는 환불되지 않습니다.<br>
<br>
<br>
<br>
결제 수단에 따라 영업일 기준 3~7일 이내 승인 취소 또는 환불처리 해드립니다.<br>
<br>
카드 환불의 경우 카드사의 정책에 따르며, 자세한 사항은 카드사에 문의 부탁드립니다.<br>
<br>
결제 취소 시, 사용한 적립금과 쿠폰은 모두 복원됩니다.<br>
<br>
배송안내 배송조회<br>
배송 안내 : 상단 상세페이지 안내를 확인하세요.<br>
교환 및 반품안내<br>
교환 및 환불이 어려운 경우<br>
샐러드는 신선식품으로 재판매가 어렵습니다. 또한 신선도를 위해 주문이 접수되고 난 다음에 제조됩니다.<br>
<br>
때문에 신선식품의 특성상 고객님의 단순 변심, 주문 오류 등으로 인한 교환 / 반품 / 환불은 불가능합니다.<br>
<br>
또한 냉장식품이기 때문에 제품 수령 후 보관상의 이유로 발생한 변질 및 파손에 대해서도 교환 / 반품 / 환불이 불가능합니다.<br>
<br>
<br>
<br>
또한 다음과 같은 이유로 배송이 지연되거나 반송이 되는 경우 환불 혹은 재발송이 불가능합니다.<br>
<br>
  - 배송 받을 주소가 사실과 다를 경우,연락처가 기재되지 않거나 잘못된 경우 (반송시 폐기)<br>
<br>
  - 고객센터를 통하지 않은 임의 반송<br>
<br>
  - 제주 및 도서,산간지역의 경우<br>
<br>
  - 천재지변 등의 불가항력인 이유로 배송이 지연되는 경우<br>
<br>
  - 택배배송이 격일로 이루어지는 군부대나 주말에 택배 배송이 어려운 기숙사 등의 장소일 경우  <br>
<br>
<br>
<br>
교환 및 환불이 가능한 경우<br>
<br>
주문한 제품과 수령한 제품이 다르거나, 제품이 표시 내용과 다르거나, 권장섭취일에 이미 유통기한이 다 되었거나, 부패했을 경우 등 
<br>
판매자의 실수나 제품에 문제가 있는 경우 교환/재발송/환불 등이 가능합니다.<br>
<br>
제품의 특성상 제품 수령 2일 이내로 연락부탁합니다. 
<br>
<br>
<br>
교환 및 환불 절차<br>
<br>
1. 제품의 이상을 사진으로 남겨 주세요 : 제품에 문제가 확인되면  배송비는 푸르뎁에서 부담합니다.<br>
<br>
2. 고객센터 혹은 1:1게시판으로 연락주세요 : 고객센터 마감시간 이후로는 1:1 문의 게시판에 남겨주세요.<br>
<br>
...
환불 안내<br>
<br>
고객센터를 통해 제품의 이상이 확인된 후 환불이 결정되면 3영업일 이내에 결제 금액을 환불해 드립니다. <br>
<br>
...
<br>
<br>
정기배송 이용 도중 취소를 할 경우,<br>
정기배송 상품은 정해진 기간동안 전체 이용을 완료할 경우를 전제로 무료배송해드립니다.<br>
만일 정상 서비스 이용 도중 판매자의 귀책이 아닌 이용자의 사유로 중단을 하고자 할 경우, <br>
전체 결제금액에서 기수령하신 샐러드의 판매금과 수령하신 횟수에 해당하는 배송료를 차감한 금액을 환불받으실 수 있습니다.<br>
정기배송 중도취소를 원할 경우 고객센터 혹은 1:1문의게시판에 남겨주세요.<br>
무통장 입금의 경우, 고객님의 계좌로 입금해드리며 카드결제의 경우 카드 부분취소로 환불이 이루어집니다.<br>
카드결제 취소의 경우 카드사의 상황에 따라 7영업일 정도 소요할 수 있습니다.<br>
서비스문의</td></tr>
						</table>
					</div>
				</div>
