...
<body>
	...
	<h2 class="page-header" onclick="location.href='adminOrderList.pulu';">주문목록</h2>
...
<script type="text/javascript">
//회원 삭제 알림 팝업
/* function checkOrderDelete(aaa, bbb) {
	
	var form = document.getElementById("adminOrderDelete");
	document.getElementById("ORDER_NUM"+bbb).value = aaa;
