            ...
            <ul class="nav navbar-top-links navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        ...
                        <li class="divider"></li>
                        <li><a href="logout.pulu"><i class="fa fa-sign-out fa-fw"></i> 관리자 로그아웃</a>
                        </li>
                    </ul>
                    <!-- /.dropdown-user -->
                </li>
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="adminMain.pulu"><i class="fa fa-wrench fa-fw"></i><strong>&nbsp 관리자 메인페이지</strong></a>
                        </li>
                        <li>
                            <a href="main.pulu"><i class="fa fa-home fa-fw"></i><strong>&nbsp 쇼핑몰 메인페이지</strong></a>
                        </li>
                        	<!-- Tab의 하위항목 펼치는 부분 -->
                        	<!-- Tab의 하위항목 펼치는 부분 -->
                        	<!-- Tab의 하위항목 펼치는 부분 -->
...
<!--                             <a href="#"><i class="fa fa-bar-chart-o fa-fw"></i> Charts<span class="fa arrow"></span></a> -->
                            <a href="#"><i class="fa fa-edit fa-fw"></i><strong>&nbsp 게시판 관리</strong><span class="fa arrow"></span></a>
                         ...
                         <li>
<!--                             <a href="#"><i class="fa fa-bar-chart-o fa-fw"></i> Charts<span class="fa arrow"></span></a> -->
                            <a href="#"><i class="fa fa-user fa-fw"></i><strong>&nbsp 회원 관리</strong><span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
...
<!--                             <a href="#"><i class="fa fa-bar-chart-o fa-fw"></i> Charts<span class="fa arrow"></span></a> -->
                         ...
                         <li>
<!--                             <a href="#"><i class="fa fa-bar-chart-o fa-fw"></i> Charts<span class="fa arrow"></span></a> -->
                            <a href="#"><i class="fa fa-pagelines fa-fw"></i><strong>&nbsp 상품 관리</strong><span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="adminGoodsList.pulu">일반상품 목록</a>
                                </li>
                                <li>
